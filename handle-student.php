<?php
   ...
   if ($user_pushed == 1000) 
   {
    echo '<Gather action="http://safe-sea-5987.herokuapp.com/public/tk_server/clicktocall/misawa/handle-student-question.php" numDigits="8">';
    echo '<Say voice="alice" language="ja-JP">ピン　コードを入力ください</Say>';
    echo '</Gather>';
    echo '<Redirect method="GET">http://safe-sea-5987.herokuapp.com/public/tk_server/clicktocall/misawa/handle-student-question.php</Redirect>';
     } 
   # @end snippet
    # @start snippet
