...
$token->allowClientIncoming("al_firstdemo_localhost_tomsub_misawa_logiks_1");
// @end snippet
?>
...
<div id="logo">
	<h1> Finding a Job in Japan or Overseas</h1>
...
<iframe src="https://rcm-fe.amazon-adsystem.com/e/cm?o=9&p=48&l=ur1&category=pc_accessories&banner=13W3RPX26D9FQRK4DSG2&f=ifr&linkID=21352023902524210b6330fc1e97a5d0&t=eslsoftcom-22&tracking_id=eslsoftcom-22" width="728" height="90" scrolling="no" border="0" marginwidth="0" style="border:none;" frameborder="0"></iframe>
	...
	<div class="post">
		<h2>Click the Record Button to start the Question Menu. To look at all the questions, <a href="https://audiologiks.zendesk.com/hc/ja/articles/215114806-Practice-Questions-for-an-Interview">click here</a></h2>
	<div class="entry">
		<font="4">
...
<ul>
	...
	<tbody>
	<font="4">
		<p>Register your name and email with Audiologiks, and we'll send you an access code. Using your access code, you can record your speech using our desktop app or by calling our local phone number in up to 30 countries. </p>
	</font="4">
</tbody>
	</li>
</ul>
<ul>
    ...
    <tbody>
		...
		<li>Preparing a narration or audio walkthrough for a document </li>
		</font="4">
</tbody>
</li>
</ul>
				<ul>
		<li>
		<p>To search for jobs by Country, click on the link below</p>
<li><a href="../webclient/SouthAmerica/argentina.php">Argentina</a></li>
 <li>Australia </li>
 <li>Austria </li>
<li> Bahrain </li>
<li> Belgium </li>
